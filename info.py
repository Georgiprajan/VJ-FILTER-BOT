...
API_ID = int(environ.get('API_ID', '4761187'))
API_HASH = environ.get('API_HASH', '9303fbfba8a6d6e6eef752418f334031')
BOT_TOKEN = environ.get('BOT_TOKEN', "1770688196:AAF96_8b429Tn0Z45aaLlbI0IFzhM7tVrak")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '983961765').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001904179420').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://MM:MM@cluster0.kky7o.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "myFirstDatabase")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'myFirstDatabase')
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'https://t.me/MalayalamDubbedMovies_1') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/requestmoviesmalayalam')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/newreleasemain')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MalayalamDubbedMovies1') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/mmadminofficial')
